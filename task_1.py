# importing randint to generate a random number
from random import randint 

# using list comprehension create list of 100 values in range from 0 to 1000 
lst = [randint(0,1000) for i in range(100)] 

# sorting list using nested loops by comapring every value in the list one by one 
...
# printing out averages - sum of the values in the list divided by number of elements
